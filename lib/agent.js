...
const DEFAULT_AGENT_BEDROCK_MODEL_ID = 'us.anthropic.claude-sonnet-4-5-20250929-v1:0';
...
class AgentConstruct extends Construct {
    constructor(scope, id, props) {
        ...
        // every construct. dependenciesLayer is also exposed so the
        // poller and notifier Python Lambdas can attach the same
        // pre-bundled layer (boto3 ships in the runtime; powertools +
        // xray-sdk + pyjwt come from this layer).
        this.function           = travelAgentFn;
        this.api                = agentApi;
        this.authorizerFunction = agentAuthorizerFn;
        this.dependenciesLayer  = dependenciesLayer;
    }
}
