...
// TODO(slice-9, ADR 0006): externalise this to AWS Secrets Manager and
// rotate per-component. The single shared literal makes every Lambda in
// the chain mintable from anywhere with repo access. Threat model
// docs/threat-model.md row "JWT_SIGNATURE_SECRET" already documents the
// risk; do not deploy to a shared environment until this is resolved.
