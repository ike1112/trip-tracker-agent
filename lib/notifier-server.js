 ...
 *   never `Resource: '*'`.
 *
 * - No SES stub mode. When the poller triggers a notification, the
 *   notifier attempts a real SES send. Fixture deploys therefore still
 *   require verified SES sender/recipient context values.
 *
