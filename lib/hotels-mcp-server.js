 ...
 *
 * Mirrors FlightsMcpServerConstruct (slice 3):
...
class HotelsMcpServerConstruct extends Construct {
    constructor(scope, id, props) {
        ...
        // Authorizer Lambda — same code as the bookings + flights authorizers
        // (lambdas/mcp-authorizer/index.js). Same JWT secret, same `sub`
        // requirement. Could be shared, but keeping per-API instances means
        // each MCP endpoint has its own deny-by-default surface.
