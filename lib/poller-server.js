    ...
    constructor(scope, id, props) {
        ...
        const pollerFn = new lambda.Function(this, 'PollerFn', {
            ...
            environment: {
                ...
                // Per-watch MCP calls. Same shared HS256 secret the agent
                // uses; the mcp-authorizer Lambda re-verifies on the way
                // in and the MCP server re-verifies in-handler as defense
                // in depth (see threat-model boundary [2]).
